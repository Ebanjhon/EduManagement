...
class ResultLearning(ModelBase):
    ...
    study_class = models.ForeignKey(StudyClass, on_delete=models.CASCADE, null=True,
                                    related_name='resultlearning_as_studyClass')  # lop hoc
...
class ScoreColumn(ModelBase):
    ...
    result_learning = models.ForeignKey(ResultLearning, on_delete=models.CASCADE,
                                        related_name='score_columns')  # ket qua hoc tap
